...
class StaticGeneratorPlugin {
  ...
  apply(compiler) {
    ...
    // compiler.hooks.compile.tap("StaticGeneratorPlugin", compilation => {
    // });

    // compiler.hooks.afterCompile.tap("StaticGeneratorPlugin", compilation => {
    // });

    // compiler.hooks.shouldEmit.tap("StaticGeneratorPlugin", compilation => {
    // })
