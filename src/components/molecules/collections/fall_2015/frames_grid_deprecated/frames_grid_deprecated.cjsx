[
  ...
  require 'components/molecules/products/collection_frame_deprecated/collection_frame_deprecated'
...
module.exports = React.createClass
  #Deprecating this component as it contains analytics built for the legacy site
